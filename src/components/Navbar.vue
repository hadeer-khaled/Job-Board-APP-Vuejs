...
<nav class="d-flex justify-content-between ">
    ...
    <div>
        <div class="d-flex">
            ...
            <a class="btn btn-primary mx-3" @click="$router.push('/candidate/applications')">Applications</a>
            <a class="btn btn-primary mx-3" @click="$router.push('/candidate/profile')">Profile</a>
