                  ...
                  <template v-for="job in posts" :key="job.id">
                      <PostCard class="mb-2"
                          ...
                          <template v-slot:Restore>
                              <Button label="Restore" class="p-button-success p-button-outlined mr-2" icon="pi pi-refresh" @click="restorePost(job.id)" />
                              <Button label="Delete" class="p-button-danger p-button-outlined" icon="pi pi-trash" @click="requireConfirmation($event, job.id)" />
                          </template>
                      </PostCard>
                  </template>
              </div>
