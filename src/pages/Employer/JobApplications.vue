<template>
  <div class="wrapper">
    ...
    <!-- <div> -->
      ...
      <div v-if="applications" class="my-container">
          ...
          <div v-if="applications.length !=0">
              <div class="card">
                <DataTable :value="applications" stripedRows tableStyle="min-width: 50rem">
                    ...
                    <Column field="candidate.experience_level" header="Experience Level"></Column>
...
export default {
    ...
    getSeverity(status) {
      ...
      fetchApplications(pageUrl = null) {
        const url = pageUrl || `${import.meta.env.VITE_BASE_URL}/job-applications/${this.job_id}`;
